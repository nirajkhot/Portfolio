const spans = documnet.querySelectorAll('h1 span')
...
const htmlBar = documnet.querySelector('.bar-html')
const cssBar = documnet.querySelector('.bar-css')
const jsBar = documnet.querySelector('.bar-javascript')
const reactBar = documnet.querySelector('.bar-react')
